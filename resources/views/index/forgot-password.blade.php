...
<head>
        ...
        <title>Moreno Montero - Contacto </title>
                    ...
                    <fieldset>
                      ...
                      <div class="col-sm-12">
                        <div class="form-group">
                          <label>Ingresa tu dirección de E-mail: </label>
                          <input type="email" name="email" class="form-control" required>
                        </div>
                      </div>
                      <div class="col-sm-12">
                        <div class="form-group">
                          <button class="btn-send submit-buttom" type="submit">ENVIAR CONTRASEÑA</button>
                        </div>
                      </div>
                    </fieldset>
                </form>
              ...
              <div class="single-sidebar">
                ...
                <div class="sidebar-recent-post">
                  ...
                  <div class="media single-post">
                    ...
                    <div class="media-body">
                      <h4 class="media-heading"><a href="single.html">Ley de Trabajo</a></h4>
                      <div class="posted-date">
                        <a href="single.html">Febrero 01, 2016</a>
                      </div>  
                      <p>Lorem ipsum dolor sit ametet</p>
